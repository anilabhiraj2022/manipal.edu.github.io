...
$(document).ready(function() {
    ...
    try {
        $('select.customparma').SumoSelect({
            placeholder: 'Select ' + jsVars.field_name_2,
            search: true,
            searchText: 'Search',
            captionFormatAllSelected: "All Selected.",
            triggerChangeCombined: true
        });
        $('select.customparmb').SumoSelect({
            placeholder: 'Select ' + jsVars.field_name_3,
            search: true,
            searchText: 'Search',
            captionFormatAllSelected: "All Selected.",
            triggerChangeCombined: true
        });
        $('select#custom_fields_1').SumoSelect({
...
function showCounsellingText(id, title) {
    ...
    $('#ActivityLogPopupArea .modal-content').css({
        'width': '100%',
        'padding-bottom': '20px'
    });
    $('#ActivityLogPopupArea .modal-body').css({
        'overflow-y': 'auto',
        'max-height': '400px'
    });
...
$(document).ready(function() {
    $('#whatsappOptStatus').on("click", function() {
        ...
        $.ajax({
            ...
            data: {
                'WhatsAppOptStatus': WhatsAppOptInStatus
            },
            type: 'post',
            dataType: 'json',
            headers: {
