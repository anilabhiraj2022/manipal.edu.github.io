...
! function(t, e) {
    ...
    return function(t) {
        ...
        var E = function() {
            function t(e, n) {
                (0, f.default)(this, t), this.el = e, this.flashTimeout, this.contentEl, this.scrollContentEl, this.dragOffset = {
                    x: 0,
                    y: 0
                }, this.isVisible = {
                    x: !0,
            ...
            return (0, d.default)(t, [{
                key: "init",
                value: function() {
                    this.el.SimpleBar = this, this.enabled && (this.initDOM(), this.scrollContentEl = this.el.querySelector("." + this.classNames.scrollContent), this.contentEl = this.el.querySelector("." + this.classNames.content), this.trackX = this.el.querySelector("." + this.classNames.track + ".horizontal"), this.trackY = this.el.querySelector("." + this.classNames.track + ".vertical"), this.scrollbarX = this.trackX.querySelector("." + this.classNames.scrollbar), this.scrollbarY = this.trackY.querySelector("." + this.classNames.scrollbar), this.scrollContentEl.style.marginRight = "-" + this.offsetSize + "px", this.scrollContentEl.style.paddingRight = this.offsetSize + "px", this.scrollContentEl.style.marginBottom = "-" + this.offsetSize + "px", this.contentEl.style.paddingBottom = this.offsetSize + "px", this.enabled && 0 !== this.scrollbarWidth && (this.scrollContentEl.style.marginBottom = "-" + 2 * this.scrollbarWidth + "px", this.contentEl.style.marginRight = "-" + this.scrollbarWidth + "px"), this.recalculate(), this.initListeners())
                }
            }, {
                key: "initDOM",
                value: function() {
                    ...
                    t.classList.add(this.classNames.track), e.classList.add(this.classNames.scrollbar), t.appendChild(e), this.trackX = t.cloneNode(!0), this.trackX.classList.add("horizontal"), this.trackY = t.cloneNode(!0), this.trackY.classList.add("vertical"), this.el.insertBefore(this.trackX, this.el.firstChild), this.el.insertBefore(this.trackY, this.el.firstChild), this.el.setAttribute("data-simplebar", "init")
                }
            }, {
                key: "initListeners",
                value: function() {
                    ...
                    this.options.autoHide && this.el.addEventListener("mouseenter", this.onMouseEnter), this.scrollbarY.addEventListener("mousedown", this.onDragY), this.scrollbarX.addEventListener("mousedown", this.onDragX), this.scrollContentEl.addEventListener("scroll", this.onScrollY), this.contentEl.addEventListener("scroll", this.onScrollX), "undefined" != typeof MutationObserver && (this.mutationObserver = new MutationObserver(function(e) {
                        ...
                        characterData: !0,
                        subtree: !0
                    })), this.resizeObserver = new g.default(this.recalculate.bind(this)), this.resizeObserver.observe(this.el)
                }
            }, {
                key: "removeListeners",
                value: function() {
                    this.enabled && (this.options.autoHide && this.el.removeEventListener("mouseenter", this.onMouseEnter), this.scrollbarX.removeEventListener("mousedown", this.onDragX), this.scrollbarY.removeEventListener("mousedown", this.onDragY), this.scrollContentEl.removeEventListener("scroll", this.onScrollY), this.contentEl.removeEventListener("scroll", this.onScrollX), this.mutationObserver.disconnect(), this.resizeObserver.disconnect())
                }
            }, {
                key: "onDragX",
                value: function(t) {
                ...
                value: function() {
                    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "y",
                        ...
                        r = void 0,
                        i = void 0;
                    "x" === t ? (e = this.trackX, n = this.scrollbarX, r = this.contentEl[this.scrollOffsetAttr[t]], i = this.contentEl[this.scrollSizeAttr[t]]) : (e = this.trackY, n = this.scrollbarY, r = this.scrollContentEl[this.scrollOffsetAttr[t]], i = this.contentEl[this.scrollSizeAttr[t]] - 15);
                    var o = e[this.sizeAttr[t]],
                        s = o / i,
                        c = r / (i - o),
                        a = Math.max(~~(s * (o - 2)) - 2, this.options.scrollbarMinSize),
                        u = ~~((o - 4 - a) * c + 2);
                    this.isVisible[t] = o < i, this.isVisible[t] ? (e.style.visibility = "visible", "x" === t ? (n.style.left = u + "px", n.style.width = a + "px") : (n.style.top = u + "px", n.style.height = a + "px")) : e.style.visibility = "hidden"
                }
            }, {
                key: "onScrollX",
                value: function() {
                ...
                key: "recalculate",
                value: function() {
                    this.enabled && (this.resizeScrollbar("x"), this.resizeScrollbar("y"), this.options.autoHide || (this.showScrollbar("x"), this.showScrollbar("y")))
                }
            }, {
                    ...
                    this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this), "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(function(e) {
                        e.forEach(function(e) {
                            (0, c.default)(e.addedNodes).forEach(function(e) {
                                1 === e.nodeType && (e.hasAttribute("data-simplebar") ? !e.SimpleBar && new t(e, t.getElOptions(e)) : (0, c.default)(e.querySelectorAll("[data-simplebar]")).forEach(function(e) {
                ...
                value: function() {
                    document.removeEventListener("DOMContentLoaded", this.initDOMLoadedElements), window.removeEventListener("load", this.initDOMLoadedElements), (0, c.default)(document.querySelectorAll("[data-simplebar]")).forEach(function(e) {
                        e.SimpleBar || new t(e, t.getElOptions(e))
                    })
                }
            }, {
        ...
        var r = n(5),
            ...
            a = function(t, e, n) {
                var u, l, f, h = t & a.F,
                    ...
                    E = d ? r : p ? r[e] : (r[e] || {})[c];
                d && (n = e);
                for (u in n) l = !h && E && void 0 !== E[u], l && u in m || (f = l ? E[u] : n[u], m[u] = d && "function" != typeof E[u] ? n[u] : b && l ? o(f, r) : y && E[u] == f ? function(t) {
                    ...
                    return e[c] = t[c], e
                }(f) : v && "function" == typeof f ? o(Function.call, f) : f, v && ((m.virtual || (m.virtual = {}))[u] = f, t & a.R && g && !g[u] && s(g, u, f)))
            };
        ...
        t.exports = function(t, e, n, m, g, E, _) {
            ...
            var x, O, w, S = function(t) {
                ...
                C = j[h] || j[p] || g && j[g],
                L = C || S(g),
                T = g ? A ? S("entries") : L : void 0,
                D = "Array" == e ? j.entries || C : C;
            if (D && (w = f(D.call(new t)), w !== Object.prototype && (l(w, M, !0), r || c(w, h) || s(w, h, y))), A && C && C.name !== b && (k = !0, L = function() {
                    return C.call(this)
                }), r && !_ || !d && !k && j[h] || s(j, h, L), a[e] = L, a[M] = y, g)
                if (x = {
                        values: A ? L : S(b),
                        keys: E ? L : S(v),
                        entries: T
        ...
        t.exports = !a || n(8)(function() {
            ...
            for (var n = s(t), a = arguments.length, u = 1, l = i.f, f = o.f; a > u;)
                for (var h, d = c(arguments[u++]), p = l ? r(d).concat(l(d)) : r(d), v = p.length, b = 0; v > b;) f.call(d, h = p[b++]) && (n[h] = d[h]);
            return n
        } : a
    }, function(t, e, n) {
        var r = n(7),
            ...
            u = function() {
                var t, e = n(21)("iframe"),
                    ...
                    i = "<",
                    s = ">";
                for (e.style.display = "none", n(43).appendChild(e), e.src = "javascript:", t = e.contentWindow.document, t.open(), t.write(i + "script" + s + "document.F=Object" + i + "/script" + s), t.close(), u = t.F; r--;) delete u[a][o[r]];
                return u()
            };
        t.exports = Object.create || function(t, e) {
            var n;
            return null !== t ? (c[a] = r(t), n = new c, c[a] = null, n[s] = t) : n = u(), void 0 === e ? n : i(n, e)
        }
    }, function(t, e, n) {
        var r = n(6),
            i = n(7),
        ...
        t.exports = function(t) {
            return function(e, n) {
                var o, s, c = String(i(e)),
                    a = r(n),
                    u = c.length;
                return a < 0 || a >= u ? t ? "" : void 0 : (o = c.charCodeAt(a), o < 55296 || o > 56319 || a + 1 === u || (s = c.charCodeAt(a + 1)) < 56320 || s > 57343 ? t ? c.charAt(a) : o : t ? c.slice(a, a + 2) : (o - 55296 << 10) + (s - 56320) + 65536)
            }
        }
    }, function(t, e, n) {
        var r = n(18),
        ...
        (function(e) {
            function n(t, e, n) {
                ...
                function f(t) {
                    return g = void 0, A && v ? i(t) : (v = b = void 0, m)
                }

                function h() {
                    void 0 !== g && clearTimeout(g), w = 0, v = O = b = g = void 0
                }
                ...
                function p() {
                    ...
                    if (v = arguments, b = this, O = t, n) {
                        ...
                        if (M) return g = setTimeout(l, e), i(O)
                    }
                ...
                return e = s(e) || 0, r(n) && (S = !!n.leading, M = "maxWait" in n, y = M ? E(s(n.maxWait) || 0, e) : y, A = "trailing" in n ? !!n.trailing : A), p.cancel = h, p.flush = d, p
            }
        ...
        (function(e) {
            ! function(e, n) {
                ...
                function r(e) {
                    for (var n = ["top", "right", "bottom", "left"], r = {}, i = 0, o = n; i < o.length; i += 1) {
                        var s = o[i],
                            c = e["padding-" + s];
                        r[s] = t(c)
                    }
                ...
                function o(e) {
                    ...
                    var c = getComputedStyle(e),
                        ...
                        h = t(c.width),
                        d = t(c.height);
                    if ("border-box" === c.boxSizing && (Math.round(h + l) !== i && (h -= n(c, "left", "right") + l), Math.round(d + f) !== o && (d -= n(c, "top", "bottom") + f)), !s(e)) {
                ...
                function a(t) {
                    var e = t.x,
                        ...
                        r = t.width,
                        i = t.height,
                        o = "function" == typeof DOMRectReadOnly ? DOMRectReadOnly : Object,
                ...
                var l = function() {
                    ...
                    f = function() {
                        ...
                        return "function" == typeof l.Map ? l.Map : function() {
                            function e() {
                                this.__entries__ = []
                            }
                            var n = {
                    ...
                    v = function() {
                        var t = Date;
                        return "object" == typeof performance && "function" == typeof performance.now && (t = performance),
                            function() {
                                return t.now()
                            }
                    }(),
                    ...
                    y = 20,
                    m = 80,
                    g = "function" == typeof MutationObserver && "object" == typeof navigator && !("Netscape" === navigator.appName && navigator.userAgent.match(/Trident\/.*rv:11/)),
                    E = function() {
                        this.isCycleContinuous_ = !g, this.listenersEnabled_ = !1, this.mutationsObserver_ = null, this.observers_ = [], this.refresh = b(this.refresh.bind(this), y, !0), this.continuousUpdateHandler_ = b(this.refresh, m)
                    };
                E.prototype.connect = function(t) {
                    this.isConnected(t) || this.observers_.push(t), this.listenersEnabled_ || this.addListeners_()
                }, E.prototype.disconnect = function(t) {
                    var e = this.observers_,
                        n = e.indexOf(t);
                    ~n && e.splice(n, 1), !e.length && this.listenersEnabled_ && this.removeListeners_()
                }, E.prototype.isConnected = function(t) {
                    return !!~this.observers_.indexOf(t)
                }, E.prototype.refresh = function() {
                    var t = this.updateObservers_();
                    t ? this.refresh() : this.isCycleContinuous_ && this.listenersEnabled_ && this.continuousUpdateHandler_()
                    ...
                    h && !this.listenersEnabled_ && (window.addEventListener("resize", this.refresh), document.addEventListener("transitionend", this.refresh), g && (this.mutationsObserver_ = new MutationObserver(this.refresh), this.mutationsObserver_.observe(document, {
                        attributes: !0,
                        childList: !0,
                        characterData: !0,
                        subtree: !0
                    })), this.listenersEnabled_ = !0, this.isCycleContinuous_ && this.refresh())
                }, E.prototype.removeListeners_ = function() {
                    h && this.listenersEnabled_ && (window.removeEventListener("resize", this.refresh), document.removeEventListener("transitionend", this.refresh), this.mutationsObserver_ && this.mutationsObserver_.disconnect(), this.mutationsObserver_ = null, this.listenersEnabled_ = !1)
                };
                var _ = function(t, e) {
                    ...
                    x = u(0, 0, 0, 0),
                    O = function() {
                        return "function" == typeof SVGGraphicsElement ? function(t) {
                    ...
                    w = function(t) {
                        this.target = t, this.broadcastWidth = 0, this.broadcastHeight = 0, this.contentRect_ = u(0, 0, 0, 0)
                    };
                ...
                var S = function(t, e) {
                    ...
                    M = function(t, e, n) {
                        ...
                        this.activeTargets_ = [], this.observationTargets_ = new f, this.callback_ = t, this.controller_ = e, this.callbackCtx_ = n
                    };
                M.prototype.observe = function(t) {
                    ...
                    if ("Element" in l && Element instanceof Object) {
                        ...
                        e.has(t) || (e.set(t, new w(t)), this.controller_.isConnected(this) || this.controller_.connect(this), this.controller_.refresh())
                    }
                    ...
                    if ("Element" in l && Element instanceof Object) {
                        if (!(t instanceof Element)) throw new TypeError('parameter 1 is not of type "Element".');
                        var e = this.observationTargets_;
                        e.has(t) && (e.delete(t), e.size || this.controller_.disconnect(this))
                    }
                }, M.prototype.disconnect = function() {
                    this.clearActive(), this.observationTargets_.clear(), this.controller_.disconnect(this)
                ...
                var C = function() {
                    return "function" == typeof l.ResizeObserver ? l.ResizeObserver : j
                }();
                return C
            })
        }).call(e, function() {
